...
export default function Login() {
  ...
  return (
    <>
      <Head><title>Sign In | SNG Books</title></Head>
      <div style={{ display:"flex", minHeight:"100vh", fontFamily:sans, background:B.bg }}>
        ...
        <div style={{
          ...
          <div style={{ position:"absolute", top:"40%", right:-40, width:160, height:160,
            borderRadius:"50%", background:"rgba(249,115,22,0.05)", pointerEvents:"none" }}/>
          ...
          {/* Middle content */}
          <div style={{ position:"relative", zIndex:1 }}>
            <h2 style={{ margin:"0 0 12px", fontSize:32, fontWeight:800, color:"#FFFFFF",
              lineHeight:1.2, letterSpacing:"-0.02em" }}>
              Your finances,<br/>fully in control.
            </h2>
            <p style={{ margin:"0 0 40px", fontSize:15, color:B.textMid, lineHeight:1.6 }}>
              ...
              {[
                ...
                <div key={label} style={{ display:"flex", alignItems:"center", gap:12 }}>
                  <div style={{ width:32, height:32, borderRadius:8,
                    ...
                    fontSize:14, color:"#F97316", flexShrink:0 }}>{icon}</div>
                  <span style={{ fontSize:13, color:B.textMid, fontWeight:500 }}>{label}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ width:"100%", maxWidth:400 }}>
            ...
            <div style={{
              background:B.surface, borderRadius:16, padding:"32px",
              ...
              <form onSubmit={handleLogin} style={{ display:"flex", flexDirection:"column", gap:20 }}>
                ...
                <div>
                  <label style={{ display:"block", fontSize:13, fontWeight:600,
                    color:B.textMid, marginBottom:7 }}>
                    Email address
                  </label>
                  <input
                    ...
                    style={{
                      width:"100%", background:B.raised, border:`1.5px solid ${B.border}`,
                      borderRadius:10, padding:"11px 14px", color:B.text, fontSize:14,
                      outline:"none", boxSizing:"border-box", fontFamily:sans,
                      transition:"border-color 0.15s, box-shadow 0.15s",
                    }}
                    onFocus={e=>{ e.target.style.borderColor=B.orange; e.target.style.boxShadow="0 0 0 3px rgba(249,115,22,0.15)"; }}
                ...
                <div>
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:7 }}>
                    <label style={{ fontSize:13, fontWeight:600, color:B.textMid }}>Password</label>
                    <span style={{ fontSize:12, color:B.orange, cursor:"pointer", fontWeight:500 }}>
                      Forgot password?
                    </span>
                  </div>
